        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="text-3xl font-semibold text-center text-gray-800 mb-4">{feature.title}</h3>
              <p className="text-2xl text-center text-gray-600">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
