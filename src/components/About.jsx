    ...
    <section className="py-16 bg-gradient-to-r from-blue-50 to-green-50">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-6xl font-bold text-center text-gray-800 mb-3">
            কাদের জন্য এটা
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-10 rounded-lg shadow-md">
              <p className="text-2xl text-gray-600 text-center">
                যারা নিজেদের উন্নতির ব্যাপারে সিরিয়াস, কিন্তু কোথা থেকে শুরু করবেন বুঝতে পারছেন না।
              </p>
            </div>
          ...
          <div className="bg-white p-10 rounded-lg shadow-lg">
            ...
            <div className="text-center">
              <h4 className="text-4xl font-semibold text-green-600 mb-3">
